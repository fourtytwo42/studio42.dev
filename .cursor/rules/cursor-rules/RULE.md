...
- Examples: `typescript-style/`, `tailwind-styling/`, `mdx-documentation/`
...
- [ ] Folder created in `.cursor/rules/` directory with kebab-case name
- [ ] `RULE.md` file created inside the folder
- [ ] Includes proper frontmatter metadata section
- [ ] Contains clear title and sections
- [ ] Provides both good and bad examples
- [ ] References other rules using `@rule-name` format
